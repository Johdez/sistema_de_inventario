...
$query3 = "SELECT * FROM categoria WHERE tipo='Mobiliario' ORDER BY codigoC ASC";
...
<div class="row">
	...
	<br>
		<form class="form-horizontal" method="post" id="afrmMobiliario" action="guardar_mobiliario.php" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="valor" class="form-control" required id="valor" placeholder="Valor $">
    </div>
  </div>
