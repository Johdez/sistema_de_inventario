                        ...
                        <tbody>
                            ...
                            <?php while($row = mysql_fetch_array($ubicacion)): ?>                            
                                <tr>
                                  ...
                                  <td><a href="edit.php?type=ubicacion&id=<?php echo $row['idSector']?>"><?php echo $row['codigoS'];?></a></td>
                                    <td><?php echo $row['nombreS'];?></td>
                                    <td><?php echo $row['codigo'];?></td>
                                    
                                     <td><a  href="eliminarUbi.php?ubicacion=<?php echo $row['idSector'];?>" title="Remove"><i class="fa fa-times-circle fa-2x text-danger "></i></a></td>
