...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="telefono" name="dui" class="form-control" required id="dui" placeholder="Numero de DUI" pattern="[0-9]{8}[-][0-9]{1}">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="telefono" name="telefono" class="form-control" id="telefono" placeholder="Numero de telefono" pattern="[0-8]{8}">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="email" name="email" class="form-control" required id="email" placeholder="Correo Electronico">
    </div>
  </div>
