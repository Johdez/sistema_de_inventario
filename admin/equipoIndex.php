                        ...
                        <tbody>
                            ...
                            <?php while($row = mysql_fetch_array($equipo)): ?>                            
                                <tr>
                                  ...
                                  <td><a href="edit.php?type=equipo&id=<?php echo $row['codigoE']?>"><?php echo $row['codigoE'];?></a></td>
                                   ...
                                   <td><?php echo $row['nombreC'];?></td>
                                    ...
                                    <td><?php echo $row['codigoS'];?></td>
                                     ...
                                     <td><a  href="eliminarEq.php?equipo=<?php echo $row['codigoE'];?>" title="Remove"><i class="fa fa-times-circle fa-2x text-danger "></i></a></td>
